...
class ConvTests(unittest.TestCase):
    ...
    def test_square_kernels(self):
        print("Running test_square_kernels")
        ...
        for kernel_size in kernel_sizes:
            ...
            print("Test passed for kernel size:", kernel_size)

    def test_horizontal_kernel(self):
        print("Running test_horizontal_kernel")
    ...
    def test_vertical_kernel(self):
        print("Running test_vertical_kernel")
    ...
    def test_increasing_filter_sizes(self):
        print("Running test_increasing_filter_sizes")
        ...
        for input_size, output_size in zip(input_sizes, output_sizes):
            ...
            self.assertTrue(torch.allclose(output, test_output, atol=ATOL))
            print("Test passed for input size:", input_size, "output size:", output_size)

    def test_decreasing_filter_sizes(self):
        print("Running test_decreasing_filter_sizes")
    ...
    def test_same_number_of_filters(self):
        print("Running test_same_number_of_filters")
        input_sizes = [(2 ** i) for i in range(0, 8)]
        output_sizes = [(2 ** i) for i in range(0, 8)]
        for input_size, output_size in zip(input_sizes, output_sizes):
            # create a conv stub
    ...
    def test_stride(self):
        ...
        for stride in strides:
            ...
            self.assertTrue(torch.allclose(output, test_output, atol=ATOL))
            print("Test passed for stride:", stride)

    def test_dilation(self):
        print("Running test_dilation")
        ...
        for dilation in dilations:
            ...
            self.assertTrue(torch.allclose(output, test_output, atol=ATOL))
            print("Test passed for dilation:", dilation)

    def test_grouping(self):
        print("Running test_grouping")
        groups = [4, 8, 16, 32, 64]
        for group in groups:
            # create a conv stub
            ...
            self.assertTrue(torch.allclose(output, test_output, atol=ATOL))
            print("Test passed for group size:", group)

    def test_biased_conv(self):
        print("Running test_biased_conv")
        input_sizes = [(2 ** i) for i in range(0, 8)]
        output_sizes = [(3 ** i) for i in range(1, 6)]
        for input_size, output_size in zip(input_sizes, output_sizes):
            # create a conv stub
    ...
    def test_zero_biased_conv(self):
        print("Running test_zero_biased_conv")
        input_sizes = [(2 ** i) for i in range(0, 8)]
        output_sizes = [(3 ** i) for i in range(1, 6)]
        for input_size, output_size in zip(input_sizes, output_sizes):
            # create a conv stub
...
class FilterTest(unittest.TestCase):
    ...
    def test_filter(self):
        ...
        for blur_size in blur_sizes:
            ...
            self.assertTrue(torch.allclose(output, test_output, atol=ATOL))
            print("Test passed for blur size:", blur_size)
